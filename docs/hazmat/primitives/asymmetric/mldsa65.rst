...
.. currentmodule:: cryptography.hazmat.primitives.asymmetric.mldsa65
...
(comparable to 192-bit security) and is suitable for applications where smaller
key and signature sizes are important. ML-DSA-65 is designed to be secure
against attacks from both classical and quantum computers.

ML-DSA-65 is suitable for signing certificates, software packages, and other
data that requires digital signatures with post-quantum security.
...
.. doctest::
    ...
    >>> from cryptography.hazmat.primitives.asymmetric.mldsa65 import MlDsa65PrivateKey
...
ML-DSA-65 can be used to create and sign X.509 certificates. When signing
...
.. doctest::
    ...
    >>> private_key = mldsa65.MlDsa65PrivateKey.generate()
    >>> public_key = private_key.public_key()
...
ML-DSA-65 can be used to create CMS (Cryptographic Message Syntax) signed
...
.. class:: MlDsa65PrivateKey
    ...
    .. classmethod:: from_private_bytes(data)
        ...
        A class method for loading an ML-DSA-65 private key encoded as
        :attr:`~cryptography.hazmat.primitives.serialization.Encoding.Raw`.

        :param data: 4032 byte private key.
        :type data: :term:`bytes-like`

        :returns: :class:`MlDsa65PrivateKey`

        :raises ValueError: If the private key is not 4032 bytes.
        ...
        .. doctest::
            ...
            ... )
            >>> loaded_private_key = mldsa65.MlDsa65PrivateKey.from_private_bytes(private_bytes)
    ...
    .. method:: private_bytes_raw()
        ...
        :return bytes: 4032-byte raw private key.
...
.. class:: MlDsa65PublicKey
    ...
    .. classmethod:: from_public_bytes(data)
        ...
        .. doctest::
            ...
            ... )
            >>> loaded_public_key = mldsa65.MlDsa65PublicKey.from_public_bytes(public_bytes)
