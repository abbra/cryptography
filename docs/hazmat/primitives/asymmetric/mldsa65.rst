...
.. class:: MlDsa65PrivateKey
    ...
    .. classmethod:: from_seed_bytes(data)
        ...
        A class method for deterministically generating an ML-DSA-65 private key
    ...
    .. method:: sign_with_context(data, context)
        ...
        Sign the data using ML-DSA-65 with an additional context string.
    ...
    .. method:: seed_bytes()
        ...
        .. doctest::
            ...
            >>> recreated_key = mldsa65.MlDsa65PrivateKey.from_seed_bytes(seed)
...
.. class:: MlDsa65PublicKey
    ...
    .. method:: verify_with_context(signature, data, context)
        ...
        Verify a signature using ML-DSA-65 with the context string that was used
