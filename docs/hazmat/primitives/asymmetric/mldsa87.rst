...
lattices, standardized in `FIPS 204`_. It provides NIST security level 3
(comparable to 192-bit security) and is suitable for applications requiring
the highest security level. ML-DSA-87 is designed to be secure
...
ML-DSA-87 supports context strings to bind additional information to signatures.
...
.. class:: MlDsa87PrivateKey
    ...
    .. classmethod:: from_seed_bytes(data)
        ...
        A class method for deterministically generating an ML-DSA-87 private key
    ...
    .. method:: sign_with_context(data, context)
        ...
        Sign the data using ML-DSA-87 with an additional context string.
    ...
    .. method:: seed_bytes()
        ...
        .. doctest::
            ...
            >>> recreated_key = mldsa87.MlDsa87PrivateKey.from_seed_bytes(seed)
...
.. class:: MlDsa87PublicKey
    ...
    .. method:: verify_with_context(signature, data, context)
        ...
        Verify a signature using ML-DSA-87 with the context string that was used
