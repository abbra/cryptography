...
.. currentmodule:: cryptography.hazmat.primitives.asymmetric.mldsa87


ML-DSA-87 is a post-quantum digital signature algorithm based on module
lattices, standardized in `FIPS 204`_. It provides NIST security level 5
(comparable to 256-bit security) and is suitable for applications requiring
the highest level of post-quantum security. ML-DSA-87 is designed to be secure
against attacks from both classical and quantum computers.

ML-DSA-87 is suitable for signing certificates, software packages, and other
data that requires digital signatures with the highest post-quantum security
level.
...
.. doctest::
    ...
    >>> from cryptography.hazmat.primitives.asymmetric.mldsa87 import MlDsa87PrivateKey
...
ML-DSA-87 can be used to create and sign X.509 certificates. When signing
...
.. doctest::
    ...
    >>> from cryptography.hazmat.primitives.asymmetric import mldsa87
    >>> from cryptography.hazmat.primitives import serialization
    >>> # Generate ML-DSA-87 key
    >>> private_key = mldsa87.MlDsa87PrivateKey.generate()
    >>> public_key = private_key.public_key()
...
ML-DSA-87 can be used to create CMS (Cryptographic Message Syntax) signed
...
.. class:: MlDsa87PrivateKey
    ...
    .. classmethod:: from_private_bytes(data)
        ...
        A class method for loading an ML-DSA-87 private key encoded as
        :attr:`~cryptography.hazmat.primitives.serialization.Encoding.Raw`.

        :param data: 4896 byte private key.
        :type data: :term:`bytes-like`

        :returns: :class:`MlDsa87PrivateKey`

        :raises ValueError: If the private key is not 4896 bytes.
        ...
        .. doctest::
            ...
            ... )
            >>> loaded_private_key = mldsa87.MlDsa87PrivateKey.from_private_bytes(private_bytes)
    ...
    .. method:: private_bytes_raw()
        ...
        :return bytes: 4896-byte raw private key.
...
.. class:: MlDsa87PublicKey
    ...
    .. classmethod:: from_public_bytes(data)
        ...
        .. doctest::
            ...
            ... )
            >>> loaded_public_key = mldsa87.MlDsa87PublicKey.from_public_bytes(public_bytes)
