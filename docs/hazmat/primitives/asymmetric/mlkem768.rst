...
.. currentmodule:: cryptography.hazmat.primitives.asymmetric.mlkem768


ML-KEM-768 is a post-quantum key encapsulation mechanism (KEM) based on
module lattices, standardized in `FIPS 203`_. It provides NIST security level 3
(equivalent to AES-192) and is recommended for general-purpose use. ML-KEM-768
allows one party to securely encapsulate a shared secret that can only be
decapsulated by the holder of the corresponding private key.

ML-KEM-768 is suitable for key establishment in protocols such as TLS, VPNs,
and other secure communication systems requiring post-quantum security.
...
.. doctest::
    ...
    >>> from cryptography.hazmat.primitives.asymmetric.mlkem768 import MlKem768PrivateKey
    >>> from cryptography.hazmat.primitives.kdf.hkdf import HKDF
    >>> from cryptography.hazmat.primitives import serialization
    >>> # Server generates a key pair
    >>> server_private_key = MlKem768PrivateKey.generate()
...
.. class:: MlKem768PrivateKey
    ...
    .. classmethod:: generate()
        ...
        Generate an ML-KEM-768 private (decapsulation) key.
    ...
    .. classmethod:: from_private_bytes(data)
        ...
        A class method for loading an ML-KEM-768 key encoded as
        :attr:`~cryptography.hazmat.primitives.serialization.Encoding.Raw`.

        :param bytes data: 2400 byte private key.

        :returns: :class:`MlKem768PrivateKey`

        :raises ValueError: If the private key is not 2400 bytes.
        ...
        .. doctest::
            ...
            >>> from cryptography.hazmat.primitives import serialization
            >>> from cryptography.hazmat.primitives.asymmetric import mlkem768
            ...
            ... )
            >>> loaded_private_key = mlkem768.MlKem768PrivateKey.from_private_bytes(private_bytes)
    ...
    .. method:: decapsulate(ciphertext)
        ...
        :param ciphertext: The 1088-byte ciphertext from encapsulation.
        :type ciphertext: :term:`bytes-like`

        :returns bytes: A 32-byte shared secret.

        :raises ValueError: If the ciphertext is not 1088 bytes.
    ...
    .. method:: private_bytes_raw()
        ...
        :return bytes: 2400-byte raw private key.
...
.. class:: MlKem768PublicKey
    ...
    .. classmethod:: from_public_bytes(data)
        ...
        :param bytes data: 1184 byte public (encapsulation) key.
        ...
        .. doctest::
            ...
            ... )
            >>> loaded_public_key = mlkem768.MlKem768PublicKey.from_public_bytes(public_bytes)
    ...
    .. method:: encapsulate()
        ...
        :returns tuple[bytes, bytes]: A tuple of (ciphertext, shared_secret).
            The ciphertext is 1088 bytes and the shared_secret is 32 bytes.
