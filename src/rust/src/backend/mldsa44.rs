...
#[pyo3::pyfunction]
fn from_private_bytes(data: CffiBuf<'_>) -> pyo3::PyResult<MlDsa44PrivateKey> {
    let pkey = openssl::pkey::PKey::private_key_from_raw_bytes_ex(data.as_bytes(), "ML-DSA-44")
...
pub(crate) mod mldsa44 {
    #[pymodule_export]
    use super::{
        from_private_bytes, from_public_bytes, generate_key, MlDsa44PrivateKey, MlDsa44PublicKey,
    };
}
